...
{
    public class AddCompanyCommandHandler : IRequestHandler<AddCompanyCommand, ErrorOr<string>>
    {
        ...
        public async Task<ErrorOr<string>> Handle(AddCompanyCommand companyRequest, CancellationToken cancellationToken)
        {
            ...
            if (isCompanyNameExists)
            {
                ...
                return Errors.Company.DuplicateCompany($"Company with name {companyRequest.Name} alredy exists.");
            }
